...
export const meta: MetaFunction = () => {
	return [
		{ title: `${siteMeta.name} | Become a tutor` },
...
*/}
			...
			<div className="lg:grid lg:min-h-screen lg:grid-cols-12">
				<aside className="relative block h-16 lg:order-last lg:col-span-5 lg:h-full xl:col-span-6">
					<img
						alt=""
						src="https://images.unsplash.com/photo-1722755417806-10e4c449e01d?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1870&q=180"
				...
				<main className="flex items-center justify-center px-8 py-8 sm:px-12 lg:col-span-7 lg:px-16 lg:py-12 xl:col-span-6">
					<div className="max-w-xl lg:max-w-3xl">
						...
						<p className="mt-4 leading-relaxed text-gray-500">
							Teaching and sharing knowledge is as easy as clicking, on estuta!
						</p>
